...
# =========================
# This prevents Render worker timeout while testing the contact form.
# Emails will appear in Render logs instead of being sent by Gmail.

EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"

EMAIL_HOST_USER = os.environ.get(
    "EMAIL_HOST_USER",
    "akehgilbert2017@gmail.com"
)
